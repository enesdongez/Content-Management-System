...
setcookie("iceriksayfasi[header5_1link]",$deger11,time()+3600*60);
...
header("Location: kompuret.php?KompanentEkle=24");//sayfayı yenileyip veritabanından hangi id li kompanentin kodlarını
