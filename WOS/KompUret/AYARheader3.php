...
setcookie("iceriksayfasi[header3_yazi]",$deger11,time()+3600*60);
...
header("Location: kompuret.php?KompanentEkle=4");//sayfayı yenileyip veritabanından hangi id li kompanentin kodlarını
